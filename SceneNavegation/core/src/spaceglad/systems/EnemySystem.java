...
import spaceglad.GameWorld;
import spaceglad.components.CharacterComponent;
import spaceglad.components.EnemyComponent;
import spaceglad.components.ModelComponent;
import spaceglad.components.PlayerComponent;
import spaceglad.managers.EntityFactory;
...
public class EnemySystem extends EntitySystem implements EntityListener {
    ...
    public void update(float delta) {
        ...
        for (Entity e : entities) {
            ...
            cm.get(e).characterController.setGravity(new Vector3(0,-10.0f,0));
